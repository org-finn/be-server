...
class JwtService(
    ...
    fun reIssue(
        ...
        val dbRefreshToken = userTokenRepository.findByDeviceId(refreshToken.deviceId)
        ...
        if (!jwtValidator.refreshTokenEquals(userRefreshTokenString, dbRefreshToken.refreshToken)) {
            ...
            userTokenRepository.deleteRefreshToken(refreshToken.deviceId)
        ...
        // 6. DB 업데이트(기존 refresh_token을 지우고 새로운 refresh_token 생성)
